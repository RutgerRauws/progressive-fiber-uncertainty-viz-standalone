...
CellFiberMultiMap::CellFiberMultiMap()
{
    ...
    std::memset(buckets.data(), 0, sizeof(Bucket) * numberOfBuckets);
...
void CellFiberMultiMap::Initialize()
{
    ...
    glBufferSubData(GL_SHADER_STORAGE_BUFFER, sizeof(GLuint), sizeof(Bucket) * numberOfBuckets, buckets.data()); //TODO: got a SIGBUS (bus error) here

...
private:
    Configuration()
    {
        ...
        REPRESENTATIVE_FIBER_COLOR = QColor(212, 25, 28);
        ...
        HULL_COLOR_AMBIENT  = QColor(44, 122, 181);
        HULL_COLOR_DIFFUSE  = QColor(169, 215, 231);
        ...
        SILHOUETTE_COLOR   = QColor(249, 249, 188);
    };

...
private:
    Configuration()
    {
        ...
        REPRESENTATIVE_FIBER_COLOR = QColor(0, 109, 44);
        ...
        HULL_COLOR_AMBIENT  = QColor(116, 196, 118);
        HULL_COLOR_DIFFUSE  = QColor(116, 196, 118);
        ...
        SILHOUETTE_COLOR   = QColor(186, 228, 179);
    };
